...
from .models import User, Semester, Subject, Module, Question, Template, Subquestion, Subquestiondetails
...
def database():
    return render_template("database.html", users=User.query.all(), sems=Semester.query.all(), subs=Subject.query.all(), mods=Module.query.all(), ques=Question.query.all(), temps=Template.query.all(), subques=Subquestion.query.all(), subqueinfo=Subquestiondetails.query.all())
